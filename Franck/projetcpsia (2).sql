...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 04 Juin 2019 à 18:05
...
INSERT INTO `panier` (`id_pa`, `quantite`, `id_p`, `id_u`, `valid`) VALUES
(44, 7, 5, 5, 1);
...
--
ALTER TABLE `commande`
  MODIFY `id_comm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT pour la table `panier`
--
ALTER TABLE `panier`
  MODIFY `id_pa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
